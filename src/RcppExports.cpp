...
RcppExport SEXP _microclass_Kmer_count3(SEXP seqsSEXP, SEXP KSEXP, SEXP namesSEXP, SEXP codonSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type seqs(seqsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type names(namesSEXP);
    Rcpp::traits::input_parameter< bool >::type codon(codonSEXP);
    rcpp_result_gen = Rcpp::wrap(Kmer_count3(seqs, K, names, codon));
    return rcpp_result_gen;
END_RCPP
}
// Kmer_countGC
IntegerMatrix Kmer_countGC(SEXP seqs, int K, bool names, bool codon);
RcppExport SEXP _microclass_Kmer_countGC(SEXP seqsSEXP, SEXP KSEXP, SEXP namesSEXP, SEXP codonSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type seqs(seqsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type names(namesSEXP);
    Rcpp::traits::input_parameter< bool >::type codon(codonSEXP);
    rcpp_result_gen = Rcpp::wrap(Kmer_countGC(seqs, K, names, codon));
    return rcpp_result_gen;
END_RCPP
}
// Kmer_countGC3
IntegerMatrix Kmer_countGC3(SEXP seqs, int K, bool names, bool codon);
RcppExport SEXP _microclass_Kmer_countGC3(SEXP seqsSEXP, SEXP KSEXP, SEXP namesSEXP, SEXP codonSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type seqs(seqsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type names(namesSEXP);
    Rcpp::traits::input_parameter< bool >::type codon(codonSEXP);
    rcpp_result_gen = Rcpp::wrap(Kmer_countGC3(seqs, K, names, codon));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP _microclass_charToIntGC(SEXP SeqSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< CharacterVector >::type Seq(SeqSEXP);
    rcpp_result_gen = Rcpp::wrap(charToIntGC(Seq));
    return rcpp_result_gen;
END_RCPP
}
// multinomClassifyCpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_microclass_Kmer_count3", (DL_FUNC) &_microclass_Kmer_count3, 4},
    {"_microclass_Kmer_countGC", (DL_FUNC) &_microclass_Kmer_countGC, 4},
    {"_microclass_Kmer_countGC3", (DL_FUNC) &_microclass_Kmer_countGC3, 4},
    ...
    {"_microclass_charToIntGC", (DL_FUNC) &_microclass_charToIntGC, 1},
